...
if ($result->num_rows > 0) {
    ...
    <input type="hidden" value="<?php echo $row["P_ID"]; ?>" name="updatePublisher"/>
　<td><input type="submit" value="修改" name="update"/></td>
</form>
<form action="deletePublisher.php" method="post">
  <input type="hidden" value="<?php echo $row["P_ID"]; ?>" name="deletePublisher"/>
...
　<td><input type="submit" value="新增出版社" name="addPublisher"/></td>
</form>
<?php } ?>
</div>
</body>
