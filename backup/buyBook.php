...
if($_POST["checkBook"] != NULL){
  ...
  <?php
      $sql = "SELECT * FROM book,publisher WHERE book.P_ID = publisher.P_ID AND book.B_ID=$value";
  ...
  <?php }
   //   $sql = "INSERT INTO orderhistory( M_ID, M_Count,M_Amount,Date) VALUES ( '$_SESSION[id]', '$_POST[P_ID]','$_POST[Price]','$_POST[ISBN]','$_POST[Author]');";
}}else{
    echo "你啥都沒買";
}
  ?>
 </table>
  <input type="submit" value="確認購買" name="buyBook"/>
  </form>
